...
**HitPawVideo** 是 [HitPaw-Official](https://github.com/HitPaw-Official) 维护的所有视频相关 AI 算法的官方导航仓库。本仓库**不直接包含**算法源代码，而是作为导航枢纽，提供各独立算法仓库的链接、说明与快速上手指引。
...
| 算法 | 描述 | 仓库链接 | 论文 |
|------|------|----------|------|
| **AnimateAnyone** | 基于单张参考图的角色动画生成 | [HitPaw-Official/AnimateAnyone](https://github.com/HitPaw-Official/AnimateAnyone) | — |
| **TalkingPhoto** | 基于音频的口型同步与人像动画 | [HitPaw-Official/TalkingPhoto](https://github.com/HitPaw-Official/TalkingPhoto) | — |
| **UniAnimate** | 可控人物视频生成统一框架 | [HitPaw-Official/UniAnimate](https://github.com/HitPaw-Official/UniAnimate) | — |
